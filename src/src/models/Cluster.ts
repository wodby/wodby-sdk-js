...
export function ClusterFromJSONTyped(json: any, ignoreDiscriminator: boolean): Cluster {
    ...
    return {
        ...
        'lastNodesReady': json['lastNodesReady'] == null ? undefined : json['lastNodesReady'],
        'lastNodesTotal': json['lastNodesTotal'] == null ? undefined : json['lastNodesTotal'],
...
export function ClusterToJSONTyped(value?: Cluster | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'lastNodesReady': value['lastNodesReady'],
        'lastNodesTotal': value['lastNodesTotal'],
        'region': value['region'],
        'zone': value['zone'],
        'ips': value['ips'],
